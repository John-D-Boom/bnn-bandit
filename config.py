...
class RLConfig:
    data_dir = '/Users/johnboom/Documents/MLMI/Advanced ML/bayesian-neural-network/reinforcement_learning/agaricus-lepiota.data.txt'
    batch_size = 64 #started with 64
    num_batches = 64 #started with 64
